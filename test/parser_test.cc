...
TEST(Parser, Precedence)
{
    std::vector<Calc::Token> infix{
        {TT::Num, 1}, {TT::Add}, {TT::Num, 2}, {TT::Mul}, {TT::Num, 3}};
...
{
    std::vector<Calc::Token> infix{{TT::Open},   {TT::Num, 1}, {TT::Add},
                                   {TT::Num, 2}, {TT::Close},  {TT::Mul},
                                   {TT::Num, 3}};
...
TEST(Parser, ComplexExpression)
{
    ...
    std::vector<Calc::Token> input{
        {TT::Num, 3.0}, {TT::Add},      {TT::Num, 4.0}, {TT::Mul},
        {TT::Num, 2.0}, {TT::Div},      {TT::Open},     {TT::Num, 1.0},
        {TT::Sub},      {TT::Num, 5.0}, {TT::Close}};
